...
def main(input_image_path, vertex_shader_path, fragment_shader_path, output_image_path):
    ...
    glutCreateWindow(b"Offscreen Rendering")
    glutHideWindow()  # Hide the window since this is offscreen rendering
...
if __name__ == "__main__":
    input_image = IMG_DIR.joinpath("dicom_test-img-cubic.png")
